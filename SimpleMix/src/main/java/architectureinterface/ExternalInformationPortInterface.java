...
public interface ExternalInformationPortInterface {
	...
	/**
	 * Generic method to receive some <code>Information</code> from a specified
	 * <code>InformationProvider</code> component.
	 * <p>
	 ...
	 * applied.
	 * 
	 * @param informationProviderAddress
	 *            Address of the <code>
	 * 										InformationProvider</code> component
	 *            to receive data from.
	 * @param informationProviderPort
	 *            Port the <code>InformationProvider
	 * 										</code>-component to receive data
	 *            from runs on.
	 * @param informationOfInterest
	 *            Type of <code>Information</code>, that shall be received.
	 * 
	 * @return The requested <code>Information
	 * 										</code>.
	 * 
	 * @throws InformationRetrieveException
	 *             Thrown, when requested <code>
	...
	/**
	 * Generic method to receive some <code>Information</code> from a specified
	 * <code>InformationProvider</code> component, sending the bypassed data.
	 * <p>
	 * If communication channel isn't safe, but transmitted data is sensitive,
	 * cryptographic measures (like authentication and encryption) should be
	 * applied.
	 ...
	 *            to receive data from.
	 * @param informationProviderPort
	 *            Port the first <code>InformationProvider</code> component to
	 *            receive data from runs on.
	 * @param informationOfInterest
	 *            Type of <code>Information</code>, that shall be received.
	 * 
	 * @return The requested <code>Information
