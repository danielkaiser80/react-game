...
public interface OutputStrategyInterface {
	 ...
	 * <p>
	 * Must return immediately (asynchronous behavior), internal output decision
	 * may be deferred.
	 * 
	 * @param request
	 *            <code>Request</code>, that shall be put out according to the
	 *            underlying output strategy.
	 */
	public void addRequest(Request request);

	/**
	 * Can be used to add a <code>Reply</code>, that shall be put out according
	 ...
	 * 
	 * @param reply
	 *            <code>Reply</code>, that shall be put out according to the
	 *            underlying output strategy.
	 */
