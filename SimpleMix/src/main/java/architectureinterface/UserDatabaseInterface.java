...
public interface UserDatabaseInterface {
	 ...
	 * 
	 * @param user
	 *            The <code>User</code> to be added.
	 * 
	 * @throws UserAlreadyExistingException
	 *             Thrown when the bypassed <code>
	 ...
	 * 
	 * @param identifier
	 *            Identifier of the <code>User</code> to be removed from the
	 *            internal database.
	 * 
	 * @throws UnknownUserException
	 *             Thrown when no <code>User</code> with the bypassed identifier
	 *             is existent.
	 */
	 ...
	 * 
	 * @param identifier
	 *            Identifier of the <code>User</code> to be returned.
	 * 
