 ...
 * <p>
 * Handles (mix) message-based connections (see package <code>Message</code>) to
 * communication partners (clients, other mixes and proxy servers) and therefore
 * abstracts from the physic communication channels.
 * <p>
 * Must be thread-safe.
 * 
...
public interface InputOutputHandlerInterface {
	 ...
	 * 
	 * @param request
	 *            Message, that shall be sent to the next communication partner.
	 * 
	...
	/**
	 * Must return an (unprocessed) <code>Request</code>, that was received from
	 * a communication partner (e. g. client or other mix), previously.
	 * <p>
	...
	/**
	 * Must accept the bypassed (already processed) <code>Reply</code> and send
	 * it to the previous communication partner (e. g. mix).
	 * <p>
	 * Must return immediately (asynchronous behavior), the process of sending
	 * itself may be deferred (e. g. if communication channel is busy).
	 * <p>
	 ...
	 * 
	 * @param reply
	 *            Message, that shall be sent to the previous communication
	 *            partner.
	 * 
	 ...
	 * 
	 * @param replies
	 *            Messages, that shall be sent to the previous communication
	 *            partner.
	 * 
	 * @see #addReply(Reply)
	 */
	...
	/**
	 * Must return an (unprocessed) <code>Reply</code>, that was received from a
	 * communication partner (e. g. proxy or other mix), previously.
	 * <p>
