...
public interface BasicMessage {
	 ...
	 * 
	 * @param newIdentifier
	 *            Value this message's identifier shall be set to.
	 */
	 ...
	 * 
	 * @return Identifier for the channel/user this message belongs to, used by
	 *         the next mix of the cascade.
	 */
	...
	/**
	 * Only a certain part of the message array must be transmitted to the
	 * cascade's next mix (Some parts (e. g. the session key for the
	 ...
	 * transmitted.
	 * 
	 * @param startIndexOfPayload
	 *            Offset of the part to be transmitted.
	 * @param payloadLength
	 *            Length of the part to be transmitted.
	 */
	public void setPayloadRange(int startIndexOfPayload, int payloadLength);
