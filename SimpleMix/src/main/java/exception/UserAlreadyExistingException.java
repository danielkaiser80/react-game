...
/**
 * Exception thrown by <code>UserDatabase.addUser()</code> when the identifier
 * of the user to be added is already in use by another user.
 * 
 * @see userdatabase
 * 
...
public final class UserAlreadyExistingException extends Exception {
	 ...
	 */
	public UserAlreadyExistingException() { /** EMPTY */
	}

	/**
	 * Returns the String "This user's identifier is already in use by another
	 * user!"
	 * 
	 * @return "This user's identifier is already in use by another user!".
	 */
	@Override
