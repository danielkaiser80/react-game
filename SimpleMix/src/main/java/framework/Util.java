...
public final class Util {
	...
	/**
	 * Converts the bypassed byte array to an Integer value.
	 * 
	 * @param byteArray
	 *            The byte array to be translated.
	 * @return "Integer" representation of the bypassed byte array.
	 */
	public static Integer byteArrayToInteger(byte[] byteArray) {
		return Integer.valueOf(byteArrayToInt(byteArray));
	}
	...
	/**
	 * Helper method, which checks whether a string is a part of a string array
	 * 
	 * @param check
	 ...
	 */
	public static boolean contains(String check, String[] pool) {
		for (String s : pool)
			if (s.equals(check))
				return true;
		return false;
