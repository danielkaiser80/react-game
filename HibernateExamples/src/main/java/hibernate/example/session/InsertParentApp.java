...
class InsertParentApp {
    ...
    public static void main(String... args) {
        ...
        try (Session session = sessionFactory.openSession()) {
            ...
            // Creating Contact entity that will be saved to the SQlite database
            final Contact myContact = new Contact("My Name", 15, "irgendwo", 15000.0f);
            final Contact yourContact = new Contact("Your Name", 20, "zu Hause", 1000.0f);
